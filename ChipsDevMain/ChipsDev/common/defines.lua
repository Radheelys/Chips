...
NDiplomacy = {
	...
	SCALED_TRUCE_YEARS = 7,						-- Additional years of truce based on % of warscore taken in war (100% warscore = full scaled truce years)
	...
	COALITION_YEARS = 14,							-- Years before coalition expire
...
NCountry = {
	...
	MAX_CROWN_COLONIES = 12,							-- How many province a country can hold in a colonial region before creating a colonial nation
	...
	REVOLUTION_DAILY_SPREAD = 2.0,			-- How much the revolution spreads each day (progress is 0-100)
...
NEconomy = {
	...
	BASE_YEARLY_INFLATION = 0.01,					-- yearly inflation increase
...
NMilitary = {
	SLACKEN_AP_DROP = 0.05,							--Defines how much AP is lost when activating slacken toggle.
	...
	ARMY_DRILL_YEARLY_DECAY = -10.0,					-- Loss from not Drilling
	ARMY_DRILL_YEARLY_GAIN = 25.0,					-- Gain from Drilling
	ARMY_DRILL_MAX = 100.0,
	ARMY_DRILL_MAX_MORALE = 0.5,
	ARMY_DRILL_SKILL_MONTHS = 40,					-- The average number of months until you get a skill increase if drilling 100% of forcelimit. Set to 0 to disable.
	...
	MOVE_LOCK_PERCENTAGE = 0.6,						-- Unit movement is locked after this percentage of progress
	REGULAR_LEADER_POWER = 1,						-- Used for generals & admirals (affects total pips)
	EXPLORER_LEADER_POWER = 0.5,					-- Used for conquistadors & explorers (affects total pips)
	...
	ARMY_ATTRITION_AT_COAST = 3,					-- How many percent attrition units take while loaded onto ships along the coast
	ARMY_ATTRITION_AT_SEA = 15,						-- How many percent attrition units take while loaded onto ships traveling open sea
	NATIVE_FEROCITY_IMPACT = 0.25,					-- how many percentage each ferocity gives in combat bonus
	...
	CAV_REGIMENT_MANPOWER_COST = 0.8, 				-- 1 = 1000 men in cost.
	ART_REGIMENT_MANPOWER_COST = 0.6, 				-- 1 = 1000 men in cost.
	...
	INFANTRY_BREAKTHROUGH = 0.2,					-- Between 0 and 1
	CAVALRY_BREAKTHROUGH = 0.8,						-- Between 0 and 1
	...
	LOOT_DEVASTATION_IMPACT = 20,						-- how much devastation full loot impacts
	SCORCHED_DEVASTATION_IMPACT = 20, 					-- how much devastation scorching impacts.
	...
	NOMAD_PLAINS_SHOCK_BONUS = 0.50, 				--
	NOMAD_NON_PLAINS_SHOCK_PENALTY = -0.25, 			--
	SUPPLYLIMIT_BASE_MULTIPLIER = 6.0, 				--
	WAR_LENGTH_DAMAGE_MODIFIER = 0.15,				-- How much (by percentage) the damage dealt will be increased each day of the combat
	BACK_LINE_MORALE_DAMAGE_TAKEN_MODIFIER = 0.5,	-- Multiplier for morale damage taken by backrow
	BACK_LINE_STRENGTH_DAMAGE_TAKEN_MODIFIER = 0.3,	-- Multiplier for strength damage taken by backrow
	MORALE_RECOVERY_SPEED = 0.05,					-- How much (by percentage) of the maximum morale that the current morale will be recovered with at a time
	MORALE_RECOVERY_SPEED_OWN_TERRITORY = 0.25,		-- How much the recovery speed for morale will be modified if unit is in controlled territory
	...
	DEFAULT_WARGOAL_BATTLESCORE_BONUS = 25,		-- Battle score bonus from winning battles
	...
	EXPLORATION_TRAVEL_TIME = 4,					-- Multiplier for travel time when exploring
	...
	CANNOT_RETREAT_DAYS = 9, 						-- How many days combat has to last before one side can retreat
	DAYS_PER_PHASE = 1,								-- How many days each fire and shock phase lasts
	DAYS_PER_SIEGE_PHASE = 24,						-- How many days each siege phase lasts
	COMBAT_DICE_SIDE = 6,							-- How many sides the dice used in combat has
	BLOCKADE_FACTOR = 4,								-- (Total sail speed / blockade_factor) * blockade_efficiency / province development
	...
	LEADER_MAX_PIPS = 12,								-- Max general/admiral pips (per skill)
	LEADER_MIN_PIPS = 3,								-- Min general/admiral pips (total)
	REBEL_LEADER_POWER = 60,							-- The higher this value, the more pips rebel leaders will have on average
	REBEL_GARRISON_GROWTH = 3,							-- Rebel garrison growth is multiplied by this value
	...
	SEA_EXPLORE_SPEED = 10,						-- Can to some extent determine exploration speed of seas and coasts by specifying how long a ship pauses between exploration targets.
	...
	ART_SUPPRESSION = 0.10,						-- The amount of reduction to unrest for each friendly artillery regiment in a province

	FORT_FLIPPING_TIME = 45,					-- Number of days it takes an influencing fort to revert the control of a province if left unhindered.
	STACKWIPE_MANPOWER_RETURN_FRACTION = 0.7,	-- Fraction of manpower that returns to pool when a stack is wiped.

	SELECT_BUILD_PROVINCE_WEIGHT_GOLD = 50.0,
	SELECT_BUILD_PROVINCE_WEIGHT_DISTANCE = 0.7,
	SELECT_BUILD_PROVINCE_WEIGHT_TIME = 50.0,
	ADMIRAL_BLOCKADE_BONUS_PER_SIEGE_PIP = 0.3,
	...
	MERCENARY_COMPANY_STARTING_MORALE = 0.7,		-- Starting morale
	...
	MERCENARY_COMPANY_MANPOWER_RECOVERY = 60,				-- How many months to recover mercenary manpower fully
	...
	SIEGE_BONUS_SUPPLIES_SHORTAGE = 2,
	SIEGE_BONUS_FOOD_SHORTAGE = 3,
	SIEGE_BONUS_WATER_SHORTAGE = 4,
